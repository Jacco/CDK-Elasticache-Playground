...
import { Aws, Names } from 'aws-cdk-lib/core';
import { Construct } from 'constructs';
import { DEFAULT_PASSWORD_EXCLUDE_CHARS } from './private/util';

/**
 * Construction properties for a CacheSecret.
 */
export interface CacheSecretProps {
  /**
   * The username.
   */
 ...
 */
export class CacheSecret extends secretsmanager.Secret {
  constructor(scope: Construct, id: string, props: CacheSecretProps) {
    ...
    super(scope, id, {
      ...
      secretName: props.secretName, // todo elasticache/redis/username/password1 / 2
